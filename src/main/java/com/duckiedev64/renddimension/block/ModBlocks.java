package com.duckiedev64.renddimension.block;
...
public class ModBlocks {
    public static final DeferredRegister.Blocks BLOCKS =
            DeferredRegister.createBlocks(RendDimensionMod.MOD_ID);

    public static final DeferredBlock<Block> RENDSTONE_BLOCK = registerBlock("rendstone_block",
